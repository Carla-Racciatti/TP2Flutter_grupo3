...
Widget _buildActorHeader(BuildContext context) {
  ...
  return Hero(
    ...
    child: Center(  // para centrar la imagen 
      child: Container(
        ...
        child: ClipRRect(
          ...
          child: FadeInImage.assetNetwork(
            placeholder: 'assets/actors_assets/loading.gif',  // No funciona. consultar profe 
            image: widget.actor['profileImage'],  // URL de la imagen
            fit: BoxFit.cover,
            fadeInDuration: Duration(seconds: 2),  
            fadeOutDuration: Duration(milliseconds: 500),
            imageErrorBuilder: (context, error, stackTrace) {
              return const Icon(Icons.person, size: 100, color: Colors.white54);  // Icono de persona en caso de que haya error con la foto
            },
          ),
        ),
      ),
